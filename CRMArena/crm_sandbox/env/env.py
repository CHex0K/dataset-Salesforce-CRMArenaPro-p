...
class ChatEnv(object):
    def __init__(
        ...
        user_model: str = "google/gemini-2.5-flash-lite",
        user_provider: Optional[str] = "openrouter",
        org_type: str = "b2b",
    ) -> None:
        super().__init__()
        self.tasks = tasks
...
class Evaluator(object):
    def __init__(self, model: str, provider: str) -> None:
        ...
        self.usage = {"provider": provider, "cost": [], "completion_tokens": [], "prompt_tokens": [], "total_tokens": []}
        self.usage_full = {"provider": provider, "cost": [], "completion_tokens": [], "prompt_tokens": [], "total_tokens": []}
        self.total_cost = 0.0
    ...
    def parse_answers(self, model_output: str, task_name: str) -> str:
        ...
        res = chat_completion(model=self.model, messages=messages, extra_body={"usage": {"include": True}})
